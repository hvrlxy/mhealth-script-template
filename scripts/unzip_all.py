...
class UnZip:
    ...
    def unzip_logs_folder(self, subject:str, date:str, project_id:str):
        '''
        ...
        path_logs = f'{DATA_PATH}{subject}@{project_id}/logs/{date}/'
        path_logs_watch = f'{DATA_PATH}{subject}@{project_id}/logs-watch/{date}/'

        path_data = f'{DATA_PATH}{subject}@{project_id}/data/{date}/'
        path_data_watch = f'{DATA_PATH}{subject}@{project_id}/data-watch/{date}/'
    ...
    def unzip_logs_watch_folder(self, subject:str, date:str, project_id:str):
        '''
        unzip all the phone logs folder
        :param subject: str
        :param date: str
    ...
    def unzip_data_watch_folder(self, subject:str, date:str, project_id:str):
        '''
        unzip all the phone logs folder
        :param subject: str
        :param date: str
